  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
        <h2 className="text-xl font-bold text-gray-900">Quản lý báo cáo</h2>
        <div className="text-sm text-gray-500">Xử lý các báo cáo vi phạm từ người dùng</div>
      </div>
          ...
          <tbody className="divide-y divide-gray-100">
            {reports.length === 0 ? (
              ...
              <tr key={report.id} className="hover:bg-gray-50/80 transition-colors">
                <td className="px-6 py-4 font-bold text-gray-900">{report.reporterName}</td>
