        ...
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100">
                <div>
                    ...
                    <h2 className="text-center text-3xl font-extrabold text-gray-900 tracking-tight">Tạo tài khoản của bạn</h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Tham gia nền tảng học thuật để bắt đầu nghiên cứu
                    </p>
                </div>
                <RegisterForm />
